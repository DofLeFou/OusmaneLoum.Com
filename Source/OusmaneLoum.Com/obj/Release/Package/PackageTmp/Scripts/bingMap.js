	...
	window.ousmaneloum = { 
		'version': '1.0', 
		'mapOptions': { 'credentials': 'Ao8B3xfn6id6f0P1lNU50Y3vKa6MoUxQkiDe7iSHzWhLhNtN_tihSZ1tvSoV4yKa', 'enableSearchLogo': false, 'showBreadcrumb': true, 'enableClickableLogo': false, 'showScalebar': false, zoom: 1.5 },
		'ga': 'UA-17614686-7',
		...
		'init': function() {
			...
			//Modernizr.load({ 'test': ( location.href.indexOf(this.url) > -1 ), 'yep': '//www.google-analytics.com/ga.js' });
